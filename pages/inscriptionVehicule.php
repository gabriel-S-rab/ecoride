...
<form  class="formInscriptionVehicule" action="">
    ...
    <input class="couleur" id="couleur" type="text" name="couleur" placeholder="entrez la couleur du véhicule">
    <label for="immatriculation">entrez l'immatriculation du véhicule :</label>
    <input class="immatriculation" id="immatriculation" type="number" name="immatriculation" placeholder="entrez le numéro d'immatriculation">
